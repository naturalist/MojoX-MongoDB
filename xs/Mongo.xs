...
extern XS(boot_MojoX__MongoDB__Connection);
extern XS(boot_MojoX__MongoDB__BSON);
extern XS(boot_MojoX__MongoDB__Cursor);
extern XS(boot_MojoX__MongoDB__OID);

MODULE = MojoX::MongoDB  PACKAGE = MojoX::MongoDB
...
BOOT:
	...
	PERL_MONGO_CALL_BOOT (boot_MojoX__MongoDB__Connection);
	PERL_MONGO_CALL_BOOT (boot_MojoX__MongoDB__BSON);
	PERL_MONGO_CALL_BOOT (boot_MojoX__MongoDB__Cursor);
	PERL_MONGO_CALL_BOOT (boot_MojoX__MongoDB__OID);
        gv_fetchpv("MojoX::MongoDB::Cursor::_request_id",  GV_ADDMULTI, SVt_IV);
        gv_fetchpv("MojoX::MongoDB::Cursor::slave_okay",  GV_ADDMULTI, SVt_IV);
        gv_fetchpv("MojoX::MongoDB::BSON::looks_like_number",  GV_ADDMULTI, SVt_IV);
        gv_fetchpv("MojoX::MongoDB::BSON::char",  GV_ADDMULTI, SVt_IV);
        gv_fetchpv("MojoX::MongoDB::BSON::utf8_flag_on",  GV_ADDMULTI, SVt_IV);
        gv_fetchpv("MojoX::MongoDB::BSON::use_boolean",  GV_ADDMULTI, SVt_IV);
...
write_query(ns, opts, skip, limit, query, fields = 0)
     ...
     PREINIT:
         ...
         SV **heval, *request_id;
     PPCODE:
         request_id = get_sv("MojoX::MongoDB::Cursor::_request_id", GV_ADD);
